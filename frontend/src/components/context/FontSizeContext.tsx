...
export function FontSizeProvider({ children }: { children: React.ReactNode }) {
    ...
    // Hämta sparad textstorlek från local storage
    useEffect(() => {
    ...
    // Uppdaterar rot-fontstorleken på <html> och sparar valet
    useEffect(() => {
...
export function useFontSize() {
    ...
    if (!context) throw new Error('useFontSize måste användas inom FontSizeProvider')
    return context
}
